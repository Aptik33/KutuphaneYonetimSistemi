...
<head>
    ...
    <title>Yönetici Giriş Formu | KYS</title>
...
{
  $count=0;
     $res=mysqli_query($link,"SELECT * FROM yönetici WHERE kullanici_adi ='$_POST[kullanici_adi]' && parola='$_POST[parola]'");
   ...
   {
    $_SESSION["yönetici"]=$_POST["kullanici_adi"]
   ?>
