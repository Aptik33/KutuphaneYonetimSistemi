...
<head>
    ...
    <title>Yönetici Kayıt Formu | ÖYS </title>
...
<body class="login" style="margin-top: -20px;">
   ...
   <?php
...

           {
                ...
                mysqli_query($link,"INSERT INTO yönetici VALUES ('','".$_POST['ad']."','".$_POST['soyad']."','".$_POST['kullanici_adi']."','".$_POST['parola']."','".$_POST['email']."','".$_POST['iletisim']."')");
